		...
		<section className="relative">
			...
			<main className="px-6 md:px-14 py-6 flex flex-col gap-6">
				...
				<div className="flex flex-col md:grid md:grid-cols-5 md:grid-rows-5 gap-6">
								...
								<AccordionContent>
									<ol className="list-decimal list-inside text-sm text-[#090E17] space-y-2">
										<li>
											...
											<br />
											Misalnya kamu ingin pesan photocard dan figura, cukup
											pilih salah satu dulu untuk mulai atur templatenya, ya!
										</li>
										<li>
											<b>Pilih template yang kamu suka</b>
											<br />
											Scroll dan temukan desain yang paling cocok dengan vibe
											kamu ✨
										</li>
										<li>
											<b>Edit template sesukamu</b>
											<br />
											Tambahkan nama, ucapan, bentuk lucu, atau foto
											kenangan—bebas kreasi!
										</li>
										<li>
											<b>Klik "Simpan" dan lihat hasilnya</b>
											<br />
											Nanti akan muncul preview dari template yang sudah kamu
											edit.
										</li>
										<li>
											<b>Kalau sudah oke, lanjut ke produk lainnya </b>
											<br />
											Ulangi langkahnya untuk produk kedua (kalau kamu beli
											lebih dari satu).
										</li>
										<li>
											<b>Terakhir, kirim ke kami</b>
											<br />
											Kami akan proses dan pastikan hasilnya sesuai dengan yang
											kamu mau! 🎁
										</li>
									</ol>
								</AccordionContent>
						...
						<div className="col-start-1 col-end-3 xl:col-end-2 row-start-1 row-end-6 bg-white rounded-xl px-6 py-5 space-y-4">
							...
							<ol className="list-decimal list-inside text-sm text-[#090E17] space-y-2">
								<li>
									<b>Pilih dulu tab produk di atas </b>
									<br />
									Misalnya kamu ingin pesan photocard dan figura, cukup pilih
									salah satu dulu untuk mulai atur templatenya, ya!
								</li>
								<li>
									<b>Pilih template yang kamu suka</b>
									<br />
								...
								<li>
									<b>Kalau sudah oke, lanjut ke produk lainnya </b>
									<br />
									Ulangi langkahnya untuk produk kedua (kalau kamu beli lebih
									dari satu).
								</li>
								<li>
									<b>Terakhir, kirim ke kami</b>
					...
					<div className="col-start-3 xl:col-start-2 col-end-6 row-start-1 row-end-8 bg-white rounded-xl px-6 py-5 space-y-4 flex flex-col">
