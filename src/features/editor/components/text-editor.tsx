...
export default function TextEditor({ text, isActive, onChange, onStyleChange, onSelect }: TextEditorProps) {
  ...
  return (
    ...
    >
      <div className="space-y-3">
        <Textarea value={text.content} onChange={handleInputChange} className="resize-none" rows={2} />
        ...
        {isActive && (
          <div className="grid grid-cols-2 gap-2">
            <div className="space-y-1">
              ...
              <Select value={text.style.fontFamily} onValueChange={(value) => onStyleChange("fontFamily", value)}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="'Flatlion Personal Use', sans-serif">Flatlion</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            <div className="space-y-1">
              ...
              <Select value={text.style.fontSize} onValueChange={(value) => onStyleChange("fontSize", value)}>
            ...
            <div className="space-y-1">
              ...
              <Select value={text.style.textAlign} onValueChange={(value) => onStyleChange("textAlign", value)}>
